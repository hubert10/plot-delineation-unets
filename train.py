...
model_Unet.save(os.getcwd()+ '/saved_model/' +'unet_collection_UNet_50epochs.hdf5')
#############################################################
# Unet Plus
...
model_Unet_plus.save(os.getcwd()+ '/saved_model/' +'unet_collection_UNet_plus_50epochs.hdf5')
##############################################################################
...
model_att_unet.save(os.getcwd()+ '/saved_model/' +'unet_collection_att_UNet_50epochs.hdf5')
...
model_Unet_from_scratch.save(os.getcwd()+ '/saved_model/' +'unet_collection_UNet_from_scratch_50epochs.hdf5')
...
model_r2_Unet_from_scratch.save(os.getcwd()+ '/saved_model/'+'unet_collection_r2_UNet_from_scratch_50epochs.hdf5')
...
model_att_unet_from_scratch.save(os.getcwd()+ '/saved_model/' +'unet_collection_att_UNet_from_scratch_50epochs.hdf5')
############################################################################
